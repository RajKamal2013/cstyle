...
#correct the spaces between tabs error.
#input :-
#		   		mutex_exit(&chanp->chan_lock);
#output :-
#				mutex_exit(&chanp->chan_lock);
#input :-
#	  		NULL, NULL, xsvnic_rx_intr, (caddr_t)chanp);
#output :-
#			NULL, NULL, xsvnic_rx_intr, (caddr_t)chanp);
#input :-
##define  XSVNIC_FWT	   		0x8000
#output :-
##define  XSVNIC_FWT			0x8000
...
#function to remove spaces between tabs.
def spaces_between_tabs (line1):
	...
	for index in range (count_issue):
		...
		space = re.findall (" ", pattern[index]);
...
#main fucntion
def main():
        fin = open ("temp7.txt", "r+");
        fout = open ("temp8.txt", "w+");
        ...
        for line in fin:
                ...
                filename_temp = "step8"+"/"+filename_temp;
                ...
                for line2 in fin0:
                        ...
                        if (len(flag) > 0):
                                flag1 = re.findall ("spaces between tabs", line2);
		...
		for line1 in fin1:
			...
			char_count = line_length (line1);
				...
				first_line = spaces_between_tabs (line1);
                                #print "----------------spaces between tabs(general)----------------------------";
