...
def non_continuation_indented_4_spaces (line1):
...
def main():
	fin = open("temp14.txt", "r+");
	fout = open("temp15.txt", "w+");
	...
	#iterate through th file name
        for line in fin:
                ...
                filename_temp = "step15"+"/"+filename_temp;
		...
		#open the error file to get the line containing cstyle error
			...
			###print line2;
                        ...
                        if (len(flag) > 0):
				##print line2;
                                flag1 = re.findall ("non-continuation indented 4 spaces", line2);
		...
		#iterate through the file
 		for line1 in fin1:
				...
				#correct the line
				first_line = non_continuation_indented_4_spaces (line1);
				#write to the file
				fout1.write (first_line);
				#print "---------------------------non continuation indented 4 spaces-----------------------------------------"; 
